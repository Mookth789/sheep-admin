<template>
  <div class="sa-user-profile" :class="type != 'oper' ? mode : ''">
    <template v-if="type != 'oper'">
      <template v-if="userData">
        <template v-if="isHover">
          <el-popover placement="top" trigger="hover" popper-class="profile-popover sa-popper">
            <div class="sa-flex">
              <div class="avatar">
                <sa-image v-if="userData.avatar" :url="userData.avatar" />
                <img v-else class="default-avatar" src="/static/images/chat/head.png" />
                <template v-if="userData">
                  <sa-svg
                  ...
                  ></sa-svg>
                  <sa-svg v-if="userData.gender == 1" class="gender" name="sa-gender-male"></sa-svg>
                  <sa-svg
    ...
    <template v-if="type == 'oper'">
      <div class="wrap">
        <div class="avatar">
          <sa-image v-if="userData.type != 'system' && userData.avatar" :url="userData.avatar" />
          <img v-else class="default-avatar" src="/static/images/chat/head.png" />
        </div>
        <div class="sa-m-l-8">
...
<script setup>
  ...
  import UserDetail from '@/app/user/admin/detail.vue';
